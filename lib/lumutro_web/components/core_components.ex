defmodule LumutroWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LumutroWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LumutroWeb.Gettext, "errors", msg, opts)
    end
  end
